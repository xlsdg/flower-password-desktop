 ...
 * This file provides type definitions for the psl module when the package's
 * exports configuration prevents automatic type resolution.
 */

declare module 'psl' {
  /**
   * Result returned when a given domain name was not parsable
   */
